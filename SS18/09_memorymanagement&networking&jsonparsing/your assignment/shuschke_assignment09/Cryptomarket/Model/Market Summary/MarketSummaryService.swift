...
final class MarketSummaryService {
    ...
    static func `default`() -> MarketSummaryService {
        let url = URL(string: "\(NetworkingConstants.BaseURL)getmarketsummary?market=$MARKET_NAME")! //get Bitcoin Name???
    ...
    init(webservice: Webservice, ressource: Ressource<MarketResult>) {
