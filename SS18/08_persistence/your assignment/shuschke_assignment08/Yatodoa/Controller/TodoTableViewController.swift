...
class TodoTableViewController: NSFetchedResultsTableViewController {
    ...
    @IBAction func filterButton(_ sender: Any) {
        ...
        //TODO: Des geht schöner
        if navigationItem.rightBarButtonItem?.title == "Alle" {
            navigationItem.rightBarButtonItem?.title = "Offene"
            
            let completedTodo = NSPredicate(format: "completed == %@", NSNumber(booleanLiteral: true))
            fetchedResultsController.fetchRequest.predicate = completedTodo
            ...
            navigationItem.rightBarButtonItem?.title = "Alle"
            
            //let allTodo = NSPredicate(format: "completed == %@", NSNumber(booleanLiteral: false))
