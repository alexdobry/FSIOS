...
class MatchingCardsLayoutViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let destVC = navVC.visibleViewController as! GameSelectionViewController
        
        destVC.scoreList = returnScore()
    ...
    func getScores(with score: Int) {
        scoreList.append(score)
        //print("getScore: \(scoreList) ")
        
    }
    
    func returnScore() -> Array<Int> {
        print("return scorelist: \(scoreList)")
        return scoreList
    }
...
extension MatchingCardsLayoutViewController: MatchingCardGameDelegate {
    ...
    func matchingCardGameGetScore(to score: Int) {
        getScores(with: score)
        //print("matchingGetScore in ext: \(score)")
    }
