...
class MarketsTableViewController: UITableViewController {
    ...
    private struct Storyboard {
        ...
        static let NotificationSettingSegueIdentifier = "ShowNotificationSettingSegue"
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        case Storyboard.MarketSummarySegueIdentifier:
            ...
            dest.market = market
        case Storyboard.NotificationSettingSegueIdentifier:
            let dest = segue.destination as! NotificationTableViewController
            
            dest.markets = markets
        default: break
        }
    }
